...
class TrainingView(ui.View):
    ...
    async def next_step(self, view, interaction: discord.Interaction, item):
    ...
    async def _show_final_exam(self, interaction: discord.Interaction):
        ...
        async def start_exam(view, interaction: discord.Interaction, item):

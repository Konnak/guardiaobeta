...
class ReportView(ui.View):
    ...
    async def atender_denuncia(self, button: ui.Button, interaction: discord.Interaction):
        await self._handle_atender(interaction)
    
    @ui.button(label="Dispensar", style=discord.ButtonStyle.secondary, emoji="❌")
    async def dispensar_denuncia(self, button: ui.Button, interaction: discord.Interaction):
...
class VoteView(ui.View):
    ...
    async def vote_ok(self, button: ui.Button, interaction: discord.Interaction):
        await self._process_vote(interaction, "OK!")
    
    @ui.button(label="Intimidou", style=discord.ButtonStyle.secondary, emoji="⚠️")
    async def vote_intimidou(self, button: ui.Button, interaction: discord.Interaction):
        await self._process_vote(interaction, "Intimidou")
    
    @ui.button(label="Grave", style=discord.ButtonStyle.danger, emoji="🚨")
    async def vote_grave(self, button: ui.Button, interaction: discord.Interaction):
...
class AppealView(ui.View):
    ...
    async def appeal_punishment(self, button: ui.Button, interaction: discord.Interaction):
        try:
